...
import { fmtMoney, fmtNumber } from '../../../shell/lib/utils'
import { icons } from '../../../shell/lib/icons'
import { StatusBadge, StripeBadge, PlanBadge, Kpi, Checklist } from '../../../shell/lib/ui'
import { ExportModal } from '../../../views/staff/modals/TenantActionModals'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-line rounded-xl shadow-card">
          ...
          <div className="p-5 space-y-2">
            <button onClick={() => navigate('auth-admins')} className="btn btn-ghost w-full justify-start">
              {icons.admins}<span>Gestionar administradores</span>
            </button>
            <button onClick={() => navigate('tenants-settings')} className="btn btn-ghost w-full justify-start">

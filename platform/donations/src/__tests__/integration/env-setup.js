...
process.env.DATABASE_URL                ??= 'postgresql://svc_platform_donations:platform_donations_secret@localhost:5433/splitpay'
...
process.env.PLATFORM_CORE_BASE_URL       = 'http://platform-core:3000'    // splitpay loopback — los tests no llaman a Stripe real

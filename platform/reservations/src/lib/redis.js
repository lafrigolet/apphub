import { createRedis, publish as sdkPublish, subscribe as sdkSubscribe } from '@apphub/platform-sdk/redis'
...
export function subscribe(handler) { return sdkSubscribe(env.REDIS_URL, 'platform', handler) }

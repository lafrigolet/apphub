...
const REQUIRED_VARS = {
  ...
  DATABASE_URL_COMMERCE:       'postgresql://a:b@localhost:5432/test',
  // Marketplace + restaurant + appointments (consolidados, ADR 021)
  DATABASE_URL_ORDERS:         'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_INVENTORY:      'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_REVIEWS:        'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_MESSAGING:      'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_SHIPPING:       'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_DISPUTES:       'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_CATALOG:        'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_MENU:               'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_RESERVATIONS:       'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_FLOOR_PLAN:         'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_KDS:                'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_POS:                'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_DELIVERY_DISPATCH:  'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_SERVICES:              'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_RESOURCES:             'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_BOOKINGS:              'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_AVAILABILITY:          'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_INTAKE_FORMS:          'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_TELEHEALTH:            'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_PACKAGES:              'postgresql://a:b@localhost:5432/test',
  DATABASE_URL_PRACTITIONER_PAYOUTS:  'postgresql://a:b@localhost:5432/test',

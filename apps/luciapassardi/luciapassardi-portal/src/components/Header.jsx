  ...
  return (
    <header id="site-header" className="site-header fixed top-0 inset-x-0 z-50">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-[72px] flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[15px] text-tinta/80">
          {navLinks.map((l) => (
        ...
        <a href={contacto.whatsappMsg} target="_blank" rel="noopener noreferrer"
          className="hidden md:inline-flex btn-zen btn-fill text-[14px] py-2.5 px-5">
          Reserva una clase
        </a>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-50">
          ...
          <div className="absolute top-0 right-0 h-full w-[78%] max-w-xs bg-crema shadow-lift p-7 flex flex-col">

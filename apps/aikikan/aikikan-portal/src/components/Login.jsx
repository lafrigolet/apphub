      ...
      <div className="login-panel">
        ...
        <div className="login-right">
          ...
          <div className="login-social">
            ...
            <button className="login-social-btn login-facebook">
          ...
          <div className="login-divider"><span>o continúa con email</span></div>
          ...
          <form className="login-form" onSubmit={e => e.preventDefault()}>
            ...
            {mode === 'login' && (
              <a href="#" className="login-forgot"><span className="slash">/</span> ¿Olvidaste tu contraseña?</a>
            )}

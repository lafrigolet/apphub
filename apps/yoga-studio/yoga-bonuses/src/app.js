...
import { adminBonusRoutes } from './routes/admin-bonus.routes.js'
import { internalBonusRoutes } from './routes/internal-bonus.routes.js'
...
export function createApp() {
  ...
  fastify.get('/health', async () => ({
    status: 'ok', service: 'yoga-bonuses', timestamp: new Date().toISOString(),
  }))

  fastify.register(bonusRoutes, { prefix: '/v1/bonuses' })
  fastify.register(adminBonusRoutes, { prefix: '/v1/admin/bonuses' })
  fastify.register(internalBonusRoutes, { prefix: '/internal/bonuses' })

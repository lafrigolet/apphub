...
export function createApp() {
  ...
  fastify.get('/health', async () => ({
    status: 'ok', service: 'yoga-bookings', timestamp: new Date().toISOString(),
  }))

  fastify.register(bookingRoutes, { prefix: '/v1/bookings' })
  ...
  fastify.addHook('onReady', async () => { startNoShowCron() })

...
export function createApp() {
  ...
  fastify.get('/health', async () => ({
    status: 'ok', service: 'yoga-classes', timestamp: new Date().toISOString(),
  }))

  fastify.register(classRoutes, { prefix: '/v1/classes' })
  fastify.register(sessionRoutes, { prefix: '/v1/sessions' })

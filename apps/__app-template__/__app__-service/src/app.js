...
// STEP: import and register your app-specific route modules here
...
export function createApp() {
  ...
  fastify.get('/health', { config: { public: true } }, async () => ({
    status: 'ok', service: '__app__-service', timestamp: new Date().toISOString(),
  }))

  // STEP: register routes
  // fastify.register(exampleRoutes, { prefix: '/v1/example' })

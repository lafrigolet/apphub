      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-10">
          ...
          <div className="reveal bg-white border border-slate-200 rounded-2xl p-6" style={{ animationDelay: '.08s' }}>
            ...
            <button onClick={cotejar} className="mt-4 w-full bg-azul-500 hover:bg-azul-600 text-white text-sm font-600 py-3 rounded-xl shadow-lg shadow-azul-500/25">Simular escaneo y cotejar</button>
          </div>
          ...
          <div className="reveal bg-white border border-slate-200 rounded-2xl p-6 flex flex-col" style={{ animationDelay: '.16s' }}>
            ...
            <input type="text" defaultValue="https://sede.agenciatributaria.gob.es/.../cotejo?nif=B12345678&numserie=2027-A/000128" className="mt-1.5 w-full text-xs font-mono p-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-azul-400 focus:ring-2 focus:ring-azul-100 outline-none" />
            ...
            <button onClick={cotejar} className="mt-auto pt-4"><span className="block w-full border border-azul-200 text-azul-600 hover:bg-azul-50 text-sm font-600 py-3 rounded-xl">Cotejar en sede AEAT</span></button>
        ...
        <div ref={resultRef} className={`mt-5 ${shown ? '' : 'hidden'}`}>
          <div className="bg-white border border-emerald-200 rounded-2xl p-6 reveal">
            <div className="flex items-center gap-3">
              ...
              <div><div className="font-display font-700 text-lg">Factura verificada</div><div className="text-sm text-slate-500">Consta en los registros de la AEAT y los datos coinciden.</div></div>
            ...
            <div className="grid sm:grid-cols-4 gap-4 mt-5 text-sm">
              <div className="border-l-2 border-slate-100 pl-3"><div className="text-xs text-slate-400">Emisor</div><div className="font-600">Ejemplo S.L.</div></div>
              <div className="border-l-2 border-slate-100 pl-3"><div className="text-xs text-slate-400">NIF</div><div className="font-mono">B12345678</div></div>
              <div className="border-l-2 border-slate-100 pl-3"><div className="text-xs text-slate-400">Nº factura</div><div className="font-mono">2027-A/000128</div></div>
              <div className="border-l-2 border-slate-100 pl-3"><div className="text-xs text-slate-400">Importe</div><div className="font-mono">121,00 €</div></div>
            </div>
          </div>
        </div>
